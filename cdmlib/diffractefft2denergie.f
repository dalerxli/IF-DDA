      ...
      do i=-imax,imax
         do j=-imax,imax
            ...
            if (k0*k0-kx*kx-ky*ky.gt.0.d0) then               
               ...
               ii=imax+i+1
               jj=imax+j+1
               Ediffkzpos(ii,jj,1)=Ediffkzpos(ii,jj,1)*fac*k02/ctmp
               Ediffkzpos(ii,jj,2)=Ediffkzpos(ii,jj,2)*fac*k02/ctmp
               Ediffkzpos(ii,jj,3)=Ediffkzpos(ii,jj,3)*fac*k02/ctmp
               Ediffkzneg(ii,jj,1)=Ediffkzneg(ii,jj,1)*fac*k02/ctmp
               Ediffkzneg(ii,jj,2)=Ediffkzneg(ii,jj,2)*fac*k02/ctmp
               Ediffkzneg(ii,jj,3)=Ediffkzneg(ii,jj,3)*fac*k02/ctmp      
